...
public class DefaultCategorySeeder implements ApplicationRunner {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(DefaultCategorySeeder.class);
    ...
    private static DefaultCategory expense(String name, String color, String icon) {
        return new DefaultCategory(name, CategoryType.EXPENSE, color, icon);
    }

    private static DefaultCategory income(String name, String color, String icon) {
        return new DefaultCategory(name, CategoryType.INCOME, color, icon);
    }
